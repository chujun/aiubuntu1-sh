...
- [ ] 1.1 在 VMware Workstation Pro 中创建 Ansible 控制节点 VM（Ubuntu Server 24.04，2C/4GB/40GB）
- [ ] 1.2 配置控制节点 VM 网络（与目标 VM 同网段）
- [ ] 1.3 在控制节点 VM 中安装 Python3、pip、Git、sshpass、rsync
