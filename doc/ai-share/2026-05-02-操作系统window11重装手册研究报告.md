...
| 16 | VS Code | 最新版 | IDE 编辑器 | 官网下载 | https://code.visualstudio.com/Download | 配置同步设置 |
| 17 | Notepad++ | 最新版 | 文本编辑器 | 官网下载 | https://notepad-plus-plus.org/downloads/ | 配置自动更新 |
| 18 | Bandizip | 最新版 | 压缩工具备选 | 官网下载 | https://www.bandizip.com/ | 关联压缩格式 |
| 19 | PowerShell | 7+ | 高级终端 | GitHub/ winget | https://github.com/PowerShell/PowerShell/releases | 配置别名 |
