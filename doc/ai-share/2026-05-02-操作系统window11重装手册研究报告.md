...
|------|------|------|----------|
| Git | 最新版 | 版本控制 | 官网下载 |
| Google Chrome | 最新版 | 浏览器 | 官网下载 |
| Python 3 | 3.10+ | 开发环境 | 官网下载 |
| Windows Terminal | 最新版 | 终端 | Microsoft Store |
| V2RayN | 最新版 | 代理工具 | GitHub 下载 |
| 飞书 | 最新版 | 办公通讯 | 官网下载 |
| 7-Zip | 最新版 | 压缩工具 | 官网下载 |
| Sublime Text | 最新版 | 代码编辑器 | 官网下载 |
| Everything | 最新版 | 文件搜索 | 官网下载 |
| VMware Workstation | 17+ | 虚拟机 | 官网下载 |
| CC Switcher | 最新版 | 代理切换 | GitHub 下载 |
| Claude Code | 最新版 | AI 编程助手 | 官网下载 |
...
| 数据项 | 源路径 | 说明 |
|--------|--------|------|
| Claude Code 配置 | `C:\Users\{旧用户}\.claude` | 插件、记忆、规则 |
| Claude Code 设置 | `C:\Users\{旧用户}\.claude.json` | 全局配置 |
| Claude Code 项目配置 | `C:\Users\{旧用户}\AppData\Roaming\Claude` | 项目数据 |
...
# 2. 在新系统恢复数据
xcopy /E /H /I "D:\Backup\.claude" "C:\Users\{新用户}\.claude"
xcopy /H "D:\Backup\.claude.json" "C:\Users\{新用户}\.claude.json"
