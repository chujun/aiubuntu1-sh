...
# 0. 更新版本元数据
SKILL_DIR="/root/.claude/skills/my-decision-tree-doc-builder"
...
# 2. 仅添加 doc/decision-trees/
git add doc/decision-trees/

# 3. 检查是否有更改
if git diff --cached --quiet; then
    echo "ℹ️ doc/decision-trees/ 无新增更改"
    exit 0
fi

# 4. 提交并推送
git commit -m "docs: 新增 ${DOC_TITLE}决策树文档
