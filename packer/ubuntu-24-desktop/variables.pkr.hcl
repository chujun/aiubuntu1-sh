# Packer Variables - Ubuntu 24.04 Desktop
# 共享变量文件

# ISO 相关配置
variable "iso_url" {
  type        = string
  default     = "D:/repository/iso/ubuntu-24.04.4-desktop-amd64.iso"
  description = "Ubuntu 24.04 Desktop ISO 本地路径或下载 URL"
}

variable "iso_checksum" {
  type        = string
  default     = "sha256:3a4c9877b483ab46d7c3fbe165a0db275e1ae3cfe56a5657e5a47c2f99a99d1e"
  description = "Ubuntu 24.04 Desktop ISO checksum"
}

# VM 配置
variable "vm_name" {
  type        = string
  default     = "ubuntu-24-04-desktop"
  description = "虚拟机名称"
}
...
variable "output_directory" {
  type        = string
  default     = "output/ubuntu-24-04-desktop"
  description = "镜像输出目录"
}
